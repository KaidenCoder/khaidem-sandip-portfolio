export default function WorkExperience() {
    return (
        <section className="work-experience" id="experience">
            ...
            <div className="work-experience-content">
                <h3>Course Instructor (Part-time) at CampK12, Online</h3>
                <p>June 2020 – October 2021</p>
                <ul>
                    <li>Taught 100+ students in HTML, CSS, JavaScript, Python, and 3D JavaScript Game Design.</li>
                    <li>Maintained a 4.9/5.0 student rating across 50+ live sessions with high engagement and satisfaction.</li>
